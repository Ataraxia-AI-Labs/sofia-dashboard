  ...
  return (
    <div className="min-h-screen bg-void">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        <div className="mb-10">
          <span className="badge badge-purple mb-4 inline-flex">Legal</span>
        ...
        <div className="glass-card p-8 space-y-8 text-text-secondary text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-text-primary font-semibold text-base mb-3">1. Aceptacion de los Terminos</h2>
            <p>
          ...
          <section>
            <h2 className="text-text-primary font-semibold text-base mb-3">2. Descripcion del Servicio</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-text-primary font-semibold text-base mb-3">3. Uso Aceptable</h2>
            <p className="mb-3">El Servicio esta disenado exclusivamente para uso por:</p>
            <ul className="space-y-1.5 ml-4">
          ...
          <section>
            <h2 className="text-text-primary font-semibold text-base mb-3">4. Facturacion y Cancelacion</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-text-primary font-semibold text-base mb-3">5. Garantia de Satisfaccion</h2>
            <p>
          ...
          <section>
            <h2 className="text-text-primary font-semibold text-base mb-3">6. Propiedad Intelectual</h2>
            <p>
          ...
          <section>
            <h2 className="text-text-primary font-semibold text-base mb-3">7. Limitacion de Responsabilidad</h2>
            <p>
          ...
          <section>
            <h2 className="text-text-primary font-semibold text-base mb-3">8. Contacto</h2>
            <p>
