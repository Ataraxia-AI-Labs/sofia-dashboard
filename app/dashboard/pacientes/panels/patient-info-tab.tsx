  ...
  return (
    <>
      ...
      <div className="glass-card p-4 space-y-3">
        <h4 className="text-xs font-semibold text-text-muted uppercase tracking-wider">Informacion</h4>
      ...
      {patient.psychometrics && (
        <div className="glass-card p-4 space-y-3">
          <h4 className="text-xs font-semibold text-text-muted uppercase tracking-wider">Psicometria</h4>
