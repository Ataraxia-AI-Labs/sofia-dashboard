  ...
  return (
    <div className="max-w-[1400px] space-y-4 animate-sentient-breathe">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="h-6 bg-surface-3 rounded-lg w-36 mb-1.5" />
          <div className="h-4 bg-surface-3 rounded-lg w-56" />
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="glass-card p-4">
            ...
            <div className="h-7 bg-surface-3 rounded-lg w-20 mb-1" />
            <div className="h-3 bg-surface-3 rounded-lg w-28" />
          </div>
        ))}
      </div>
      ...
      <div className="space-y-1.5">
        <div className="h-3 bg-surface-3 rounded-lg w-12" />
      ...
      {/* Filter: Type */}
      <div className="space-y-1.5">
        <div className="h-3 bg-surface-3 rounded-lg w-10" />
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-start gap-3 flex-1">
                ...
                <div className="flex-1 space-y-1.5">
                  ...
                  <div className="h-3 bg-surface-3 rounded-lg w-full max-w-sm" />
                  <div className="h-3 bg-surface-3 rounded-lg w-20" />
                </div>
              </div>
              <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
                <div className="h-3 bg-surface-3 rounded-lg w-16" />
                <div className="h-6 bg-surface-3 rounded-lg w-24" />
