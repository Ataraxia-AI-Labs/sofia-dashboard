            ...
            <tr key={h.id} className={`border-b border-border/30 ${!h.is_active ? 'opacity-40' : ''}`}>
              ...
              <td className="px-4 py-2.5">
                <input
                  ...
                  className="px-2 py-1 rounded-md bg-void border border-border text-text-primary text-xs font-body outline-none focus:border-brand-purple/40"
                />
              </td>
              <td className="px-4 py-2.5">
                <input
              ...
              <td className="px-4 py-2.5">
                <input
                  ...
                  className="w-16 px-2 py-1 rounded-md bg-void border border-border text-text-primary text-xs font-body outline-none focus:border-brand-purple/40"
                />
              </td>
