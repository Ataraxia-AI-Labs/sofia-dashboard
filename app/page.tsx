...
function AnimatedStat({ value, suffix, label, delay = 0 }: {
  ...
  return (
    <div ref={ref} className="text-center">
      ...
      <div className="text-text-muted text-xs font-body mt-1.5 leading-snug">{label}</div>
    </div>
  )
}
      ...
      <div className="bg-surface/95 backdrop-blur-xl border-t border-brand-purple/30 px-4 py-3 lg:py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <Link
              href="/onboarding"
              className="px-5 py-2 rounded-md bg-brand-purple text-white font-semibold text-sm font-body flex items-center gap-2 hover:bg-brand-purple-dark transition-colors"
            >
...
function FeatureCard({ icon, title, description, highlight }: {
  ...
  return (
    <div className={`bg-brand-purple/8 border border-brand-purple/15 rounded-lg p-5 hover:border-brand-purple/30 transition-all duration-300 group cursor-default ${highlight ? 'border-brand-purple/25' : ''}`}>
      ...
      <h3 className="font-semibold font-body text-text-primary mb-1.5 text-sm">{title}</h3>
      <p className="text-text-muted text-xs font-body leading-relaxed">{description}</p>
    </div>
  )
}
...
function TestimonialCard({ quote, name, role, clinic, stars = 5 }: {
  ...
  return (
    <div className="bg-brand-purple/8 border border-brand-purple/15 rounded-lg p-5 flex flex-col gap-3">
      ...
      <p className="text-text-secondary text-xs font-body leading-relaxed italic">&ldquo;{quote}&rdquo;</p>
      <div className="flex items-center gap-3 pt-2 border-t border-border">
        <div className="w-8 h-8 rounded-md bg-brand-purple/15 flex items-center justify-center text-brand-purple font-bold text-xs font-body flex-shrink-0">
          {name[0]}
        </div>
        <div>
          <div className="text-text-primary text-xs font-semibold font-body">{name}</div>
          <div className="text-text-dim text-[13px] font-body">{role} &bull; {clinic}</div>
        </div>
      </div>
    </div>
  )
    ...
    <div className="bg-brand-purple/8 border border-brand-purple/15 rounded-lg p-6 max-w-2xl mx-auto">
      ...
      <div className="space-y-5 mb-6">
        <div>
          <div className="flex justify-between mb-2">
            <label className="text-[11px] font-medium font-body text-text-muted uppercase tracking-wider">
              Pacientes / mes
            </label>
            <span className="text-brand-purple font-bold font-body text-sm">{patients}</span>
          </div>
          <input
        ...
        <div>
          <div className="flex justify-between mb-2">
            ...
            <span className="text-brand-purple font-bold font-body text-sm">{noshow}%</span>
          </div>
          <input
        ...
        <div>
          <div className="flex justify-between mb-2">
            ...
            <span className="text-brand-purple font-bold font-body text-sm">{fmt(ticket)}</span>
          </div>
          <input
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        <div className="bg-surface-3 rounded-md p-3 text-center">
          ...
          <div className="text-[12px] font-body text-text-dim mt-1">Citas recuperadas</div>
        </div>
        <div className="bg-surface-3 rounded-md p-3 text-center">
          <div className="text-base font-bold font-mono text-brand-purple">{fmt(adminCostSaved)}</div>
          <div className="text-[12px] font-body text-text-dim mt-1">Horas admin liberadas</div>
        </div>
        <div className="bg-surface-3 rounded-md p-3 text-center border border-brand-purple/30">
          ...
          <div className="text-[12px] font-body text-text-dim mt-1">ROI total / mes</div>
        </div>
      </div>
    ...
    <div ref={ref} className="max-w-sm mx-auto">
      ...
      <div className="bg-[#111B21] rounded-lg border border-border overflow-hidden">
        ...
        <div className="bg-[#1F2C34] px-4 py-3 flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-brand-purple flex items-center justify-center text-white text-xs font-bold font-body flex-shrink-0">
            CS
          </div>
          <div>
      ...
      <p className="text-center text-text-dim text-[13px] font-body mt-3">
      ...
      <div className="min-h-screen bg-void text-text-primary">
        ...
        <nav className="fixed top-0 left-0 right-0 z-40 bg-void/80 backdrop-blur-xl border-b border-border/50">
          <div className="max-w-7xl mx-auto px-4 lg:px-8 h-16 flex items-center justify-between">
            ...
            {/* Desktop nav links */}
            <div className="hidden md:flex items-center gap-6 text-xs font-body text-text-muted">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href="/onboarding"
                className="px-4 py-2 rounded-md bg-brand-purple text-white font-semibold text-xs font-body flex items-center gap-1.5 hover:bg-brand-purple-dark transition-colors"
              >
            ...
            <div className="md:hidden bg-surface border-b border-border px-4 py-4 space-y-2 animate-fade-in">
              {['#features', '#demo', '#testimonials', '#pricing'].map((href, i) => (
                <a
                  ...
                  className="block py-2 text-xs font-body text-text-muted hover:text-text-primary transition-colors"
                >
        ...
        <section className="relative pt-28 pb-20 lg:pt-36 lg:pb-28 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              {/* Subheadline */}
              <p className="text-text-secondary text-base lg:text-lg font-body leading-relaxed mb-3 max-w-2xl mx-auto animate-fade-up">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center items-center mb-5 animate-fade-up">
                ...
                <a
                  href="#demo"
                  className="px-7 py-3.5 rounded-lg bg-surface-2 border border-border text-text-muted font-semibold text-sm font-body hover:border-brand-purple/30 hover:text-text-primary transition-all w-full sm:w-auto text-center"
                >
                  Ver demo en vivo
                </a>
              </div>
        ...
        <section className="py-14 lg:py-18 bg-surface/20">
          <div className="max-w-4xl mx-auto px-4 lg:px-8 text-center">
            ...
            <p className="text-text-muted text-sm font-body leading-relaxed mb-10 max-w-2xl mx-auto">
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="font-body text-2xl lg:text-4xl font-bold text-text-primary mb-4">
                  Mira a SofIA{' '}
                ...
                <div className="space-y-3 mb-8">
                  {[
                    ...
                    <div key={step} className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-md bg-brand-purple/8 border border-brand-purple/15 flex items-center justify-center text-brand-purple text-[11px] font-bold font-body flex-shrink-0">
                        {step}
                      </div>
                      <p className="text-text-secondary text-xs font-body">{text}</p>
                    </div>
                  ))}
                </div>
            ...
            <div className="max-w-lg mx-auto">
              ...
              <div className="relative">
                ...
                <div className="relative bg-brand-purple/8 border border-brand-purple/25 rounded-lg p-6">
                  <div className="text-center mb-6">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-brand-gold/10 border border-brand-gold/30 text-brand-gold text-[13px] font-body font-semibold mb-3">
                      <Star size={10} className="fill-brand-gold" /> MAS POPULAR
                    </div>
                    <div className="text-4xl font-bold font-mono text-text-primary mb-1">
                      $997
                    </div>
                    <div className="text-text-muted text-xs font-body">USD / mes — facturado mensualmente</div>
                    <div className="text-brand-cyan text-[13px] font-body mt-1 font-medium">
                      ~COP 4,000,000 / mes
                    </div>
                  </div>
                  ...
                  <div className="space-y-2.5 mb-6">
                    {[
                      ...
                      <div key={feature} className="flex items-start gap-2.5">
                        ...
                        <span className="text-text-secondary text-xs font-body">{feature}</span>
                      </div>
                    ))}
                  </div>
        ...
        <section className="py-16 lg:py-28 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 lg:px-8 text-center relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-status-danger/10 border border-status-danger/30 text-status-danger text-xs font-body font-medium mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center mb-6">
              <Link
                href="/onboarding"
                className="group px-8 py-4 rounded-lg bg-brand-purple text-white font-bold text-lg font-body flex items-center gap-2.5 hover:bg-brand-purple-dark transition-colors duration-300 hover:scale-[1.02] w-full sm:w-auto justify-center"
              >
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
              ...
              <div className="flex flex-col items-center lg:items-end gap-1.5">
                <div className="flex items-center gap-2 text-[13px] font-body text-text-dim">
                ...
                <a
                  ...
                  className="flex items-center gap-2 text-[13px] font-body text-[#25D366] hover:text-[#128C7E] transition-colors"
                >
